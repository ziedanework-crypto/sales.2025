...
sales_data = {
    "المنطقة": [
        "شبين القناطر", "الخانكة", "قليوب", "القناطر الخيرية", "طوخ",
        "بنها", "كبار العملاء", "المخازن"
    ],
    "يوليو": [1826209, 1700581, 1815191, 1902783, 1202928, 1922000, 655318, 672813],
    "أغسطس": [1817665, 1728044, 1856191, 1944783, 1235888, 1944000, 706123, 1556964],
    "سبتمبر": [1872665, 1775200, 1864000, 1983872, 1253000, 1983000, 707123, 964000]
}
...
customers_data = {
    ...
    "يوليو": [147, 148, 174, 174, 117, 112, 11, 5],
    "أغسطس": [154, 172, 184, 178, 108, 111, 12, 4],
    "سبتمبر": [149, 179, 178, 182, 122, 124, 11, 4]
}
...
warehouse_sales = sales_df[sales_df["المنطقة"] == "المخازن"].iloc[0, 1:]
warehouse_customers = customers_df[customers_df["المنطقة"] == "المخازن"].iloc[0, 1:]
